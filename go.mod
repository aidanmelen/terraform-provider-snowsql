module github.com/aidanmelen/terraform-provider-snowsql

go 1.17

require (
	github.com/chanzuckerberg/terraform-provider-snowflake v0.25.25
...
require (
	...
	github.com/chanzuckerberg/go-misc v0.0.0-20210907173712-618127c04a73 // indirect
